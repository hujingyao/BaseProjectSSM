		...
		<div class="login" style="display: block;">
			...
			<div class="login-center clearfix">
				...
				<div class="login-center-input">
					...
					<img id="cpacha-img" title="点击切换验证码" style="cursor:pointer;"  src="get_cpacha?vl=4&w=110&h=30&type=loginCpacha" width="110px" height="30px" onclick="changerCpacha()">
				</div>
			</div>
